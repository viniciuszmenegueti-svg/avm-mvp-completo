...
def upgrade() -> None:
    op.add_column(
        "order_refusals",
        sa.Column("contract_reference", sa.String(length=100), nullable=False, server_default="TR §9.5"),
    )
    op.add_column(
        "order_refusals",
    ...
    op.add_column("order_refusals", sa.Column("model_version", sa.String(length=50), nullable=True))
    op.add_column("order_refusals", sa.Column("dataset_version", sa.String(length=100), nullable=True))
